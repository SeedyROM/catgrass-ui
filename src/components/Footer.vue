<template>
  <footer class="items-center p-4 bg-gray-50 footer text-neutral-content">
    ...
    <div
      class="grid-flow-col gap-4 mx-auto md:justify-self-end md:place-self-center md:mx-0"
    >
      <a
        class="flex mr-4 opacity-60 hover:opacity-100 text-neutral-content"
        href="#"
        target="_blank"
      >
        <svg
      ...
      <a
        class="flex mr-4 text-gray-500 hover:text-gray-600"
